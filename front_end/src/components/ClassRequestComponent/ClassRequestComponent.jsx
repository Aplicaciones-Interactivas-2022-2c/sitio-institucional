...
import { enrollClass } from '../../services/class-enrollment.service';
const ClassRequestComponent = (props) => {
    ...
    return (<Dialog open={props.open} onClose={props.handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
