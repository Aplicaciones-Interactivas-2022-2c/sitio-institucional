...
const FormComponent = () => {
  ...
  const buscarClases = () => {
    navigate(
      `/classes?clase=${materia?.label}&frecuencia=${frecuencia?.label}&tipoDeClase=${tipoDeClase?.label}&calificacion=${calificacion?.label}`,
      {
        state: {
          materia,
          tipoDeClase,
  ...
  return (
    <div className={styles.container}>
      <div className={styles.fila}>
        <DropdownComponent
          onInputChange={getSelectedMateria}
          options={materias}
          label="Materias"
        ></DropdownComponent>
      </div>
      <div className={styles.fila}>
        <DropdownComponent
          onInputChange={getTipoDeClase}
          options={tiposDeClases}
          label="Tipo de Clase"
        ></DropdownComponent>
      </div>
      <div className={styles.fila}>
        <DropdownComponent
          onInputChange={getFrecuencia}
          options={frecuencias}
          label="Frecuencia"
        ></DropdownComponent>
      </div>
