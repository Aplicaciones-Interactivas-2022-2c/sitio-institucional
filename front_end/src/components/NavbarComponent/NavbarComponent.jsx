    ...
    return (
      <>
        ...
        <Typography
          ...
          align="right"
        >
          <a className={styles.login} href="/register">
            Register{" "}
          </a>
        </Typography>
      </>
    ...
    return (
      <>
        ...
        <Typography
          ...
          align="left"
        >
          <a className={styles.title} href="/inscriptions">
            Mis Clases{" "}
          </a>
        </Typography>
      </>
    ...
    return (
      <>
        ...
        <Typography
          ...
          align="left"
        >
          <a className={styles.title} href="/publish-class">
            Publicar Clase
          </a>
        </Typography>
        <Typography
          ...
          align="left"
        >
          <a className={styles.title} href="/assigned-classes">
            Mis Clases{" "}
          </a>
        </Typography>
      </>
    ...
    <header>
      <Box sx={{ flexGrow: 1 }}>
        <AppBar position="static" theme={theme}>
          <Toolbar className={styles.barra} theme={theme}>
            <Typography
              variant="h6"
              component="div"
              className={styles.contenedor}
