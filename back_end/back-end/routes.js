...
router.post(
  ...
  ProfessorExperienceController.createExperience
);
router.post(
  "/api/update-experience",
  ProfessorExperienceController.updateExperience
);
router.delete(
  "/api/delete-experience",
  ProfessorExperienceController.deleteExperience
);
router.post(
  "/api/get-professor-experience",
  ProfessorExperienceController.findProfessor
);
...
router.get(
  ...
  ClassEnrollmentController.findAllRequests
);
router.post(
  "/api/update-class-requests",
  ClassEnrollmentController.updateStudentRequest
);
